...
def create_generic_routes(
    ...
    def get_all(user: str = Depends(authenticate)):
    ...
    def create(item: schema_create, user: str = Depends(authenticate)):
    ...
    def get_by_id(id: str, user: str = Depends(authenticate)):
    ...
    def update(id: str, item: schema_update, user: str = Depends(authenticate)):
    ...
    def delete(id: str, user: str = Depends(authenticate)):
        if repo.delete(id):
